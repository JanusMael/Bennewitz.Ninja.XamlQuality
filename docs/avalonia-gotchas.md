...
Foot-guns measured while building Avalonia applications, recorded so the next contributor — or the
next AI session — does not rediscover them. Each entry gives the symptom, the cause, and the fix.
