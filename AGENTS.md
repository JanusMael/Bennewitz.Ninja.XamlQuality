...
| An attached property is read in both spellings, attribute and property element | Whatever is written in the unread spelling passes | `AutomationName.IsDeclaredOn`; `AutomationIdentifier.Of`; `GridSlotOverflowRule` (its private `Definitions`); tests `InteractiveAutomationNameRuleTests.ThePropertyElementSpelling_Counts`, `InteractiveAutomationIdRuleTests.ThePropertyElementSpelling_Counts`, `GridSlotOverflowRuleTests.ThePropertyElementSpellingOfRowDefinitions_Counts` |
